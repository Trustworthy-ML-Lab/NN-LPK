...
def get_datasets(name, root, cutout, train_aug=True):
    ...
    if name == 'cifar10':
        if train_aug:
            ...
            train_data = dset.CIFAR10(root, train=True, transform=test_transform, download=True)
        ...
        if train_aug:
            ...
            train_data = dset.CIFAR100(root, train=True, transform=test_transform, download=True)
